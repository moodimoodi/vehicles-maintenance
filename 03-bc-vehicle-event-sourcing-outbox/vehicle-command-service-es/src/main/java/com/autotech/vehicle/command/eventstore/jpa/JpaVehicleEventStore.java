package com.autotech.vehicle.command.eventstore.jpa;
    ...
    public void save(String aggregateId,
        ...
        for (Object event : events) {
            ...
            try {
                ...
                // Construct Json payload object for the outbox event
